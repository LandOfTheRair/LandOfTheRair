...
import { Allegiance, Direction } from '@lotr/interfaces';
import { directionHasAll } from './direction';

export const basePlayerSprite = (
  player: IPlayer | { allegiance: Allegiance; gender: 'male' | 'female' },
) => {
  let choices = { male: 725, female: 675 };

  switch (player.allegiance) {
    case Allegiance.Townsfolk: {
      choices = { male: 725, female: 675 };
      break;
    }
    case Allegiance.Wilderness: {
      choices = { male: 730, female: 680 };
      break;
    }
    case Allegiance.Royalty: {
      choices = { male: 735, female: 685 };
      break;
    }
    case Allegiance.Adventurers: {
      choices = { male: 740, female: 690 };
      break;
    }
    case Allegiance.Underground: {
      choices = { male: 745, female: 695 };
      break;
    }
    case Allegiance.Pirates: {
      choices = { male: 750, female: 700 };
      break;
    }
  }
...
export const basePlayerSwimmingSprite = (player: IPlayer) => {
  ...
  switch (player.allegiance) {
    case Allegiance.Townsfolk: {
      choices = { male: 6, female: 0 };
      break;
    }
    case Allegiance.Wilderness: {
      choices = { male: 7, female: 1 };
      break;
    }
    case Allegiance.Royalty: {
      choices = { male: 8, female: 2 };
      break;
    }
    case Allegiance.Adventurers: {
      choices = { male: 9, female: 3 };
      break;
    }
    case Allegiance.Underground: {
      choices = { male: 10, female: 4 };
      break;
    }
    case Allegiance.Pirates: {
      choices = { male: 11, female: 5 };
      break;
    }
  }
 ...
 */
export const spriteForCreatureDirection = (
  index: number,
  direction: Direction,
): number => {
 ...
 */
export const spriteOffsetForSwimmingDirection = (
  direction: Direction,
): number => {
  switch (direction) {
    case Direction.Center:
...
export const spriteDirectionForWall = (index: number): Direction => {
  ...
  const wallDirectionData = [
    0b000_0_0_000, 0b010_1_1_010, 0b000_1_1_010, 0b010_1_0_010, 0b010_1_1_000,
    0b010_0_1_010, 0b000_0_1_010, 0b000_1_0_010, 0b010_1_0_000, 0b010_0_1_000,
    0b000_0_0_010, 0b000_1_0_000, 0b010_0_0_000, 0b000_0_1_000, 0b010_0_0_010,
    0b000_1_1_000,
  ];
  let column = index % 16;
 ...
 */
export const spriteTerrainForDirection = (
  index: number,
  direction: Direction,
): number => {
  ...
  if (directionHasAll(direction, Direction.WestAndSouth)) {
    allowedDirs |= Direction.Southwest;
  }

  if (directionHasAll(direction, Direction.EastAndNorth)) {
    allowedDirs |= Direction.Northeast;
  }

  if (directionHasAll(direction, Direction.EastAndSouth)) {
    allowedDirs |= Direction.Southeast;
  }
