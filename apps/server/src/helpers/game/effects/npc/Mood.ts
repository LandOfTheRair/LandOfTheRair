...
const moods = [
  {
    color: '#008080',
    text: 'This creature is calm. -25% Damage',
    damageFactor: -0.25,
  },
  {
    color: '#5f5f00',
    text: 'This creature is agitated. -10% Damage',
    damageFactor: -0.1,
  },
  {
    color: '#004000',
    text: 'This creature is acting normally.',
    damageFactor: 0,
  },
  {
    color: '#664200',
    text: 'This creature is angered. +10% Damage',
    damageFactor: 0.1,
  },
  {
    color: '#ff0000',
    text: 'This creature is desperate. +25% Damage',
    damageFactor: 0.25,
  },
  {
    color: '#330000',
    text: 'This creature is enraged! +50% Damage',
    damageFactor: 0.5,
  },
];
