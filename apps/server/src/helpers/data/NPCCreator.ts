...
import type { Gender } from 'fantastical';
...
import {
  ...
  BinderBehavior,
  BufferBehavior,
  ChristmasSantaBehavior,
  CosmeticBehavior,
  CrierBehavior,
  CulinarianBehavior,
  EncrusterBehavior,
  EventPlannerBehavior,
  ExitWarperBehavior,
  FurUpgraderBehavior,
  GuildClerkBehavior,
  GuildmasterBehavior,
  HallOfHeroesBehavior,
  HalloweenCandyBehavior,
  HPDocBehavior,
  IdentifierBehavior,
  ItemModderBehavior,
  MagicianBehavior,
  ...
  PeddlerBehavior,
  ResetterBehavior,
  RNGArtificerBehavior,
  SmithBehavior,
  SpoilerLoggerBehavior,
  SteelroseBehavior,
  SuccorerBehavior,
  TannerBehavior,
  ThanksgivingFoodBehavior,
  ThanksgivingGunsBehavior,
  ThanksgivingTurkeyBehavior,
  TrainerBehavior,
  TreasureClaimerBehavior,
  trickOrTreat,
  TrinketManagerBehavior,
  UpgraderBehavior,
  VendorBehavior,
  worldGetMapAndState,
} from '@lotr/core';
...
export class NPCCreator extends BaseService {
  ...
  private chooseItem(
    ...
    const chosenItem = this.game.lootHelper.chooseWithReplacement(
  ...
  private loadItem(itemName: string) {
    return this.game.itemCreator.getSimpleItem(itemName);
  }
      ...
      const logicCallback: any = ({ env }) => {
        ...
        for (const action of actions) {
          const { messages, shouldContinue } =
            this.game.dialogActionHelper.handleAction(action, npc, env.player);
  ...
  private assignNPCBehavior(npc: INPC, npcDef: INPCDefinition): void {
    ...
    const behaviorTypes: Record<BehaviorType, any> = {
      [BehaviorType.Crier]: CrierBehavior,
      [BehaviorType.Trainer]: TrainerBehavior,
      [BehaviorType.Vendor]: VendorBehavior,
      [BehaviorType.Peddler]: PeddlerBehavior,
      [BehaviorType.Identifier]: IdentifierBehavior,
      [BehaviorType.Tanner]: TannerBehavior,
      [BehaviorType.Culinarian]: CulinarianBehavior,
      [BehaviorType.Alchemist]: AlchemistBehavior,
      [BehaviorType.Banker]: BankerBehavior,
      [BehaviorType.Encruster]: EncrusterBehavior,
      [BehaviorType.Smith]: SmithBehavior,
      [BehaviorType.Magician]: MagicianBehavior,
      [BehaviorType.Steelrose]: SteelroseBehavior,
      [BehaviorType.Succorer]: SuccorerBehavior,
      [BehaviorType.Upgrader]: UpgraderBehavior,
      [BehaviorType.HallOfHeroes]: HallOfHeroesBehavior,
      [BehaviorType.HPDoc]: HPDocBehavior,
      [BehaviorType.MPDoc]: MPDocBehavior,
      [BehaviorType.Binder]: BinderBehavior,
      [BehaviorType.ItemModder]: ItemModderBehavior,
      [BehaviorType.Cosmetic]: CosmeticBehavior,
      [BehaviorType.Buffer]: BufferBehavior,
      [BehaviorType.Resetter]: ResetterBehavior,
      [BehaviorType.AXPSwapper]: AXPSwapperBehavior,
      [BehaviorType.FurUpgrader]: FurUpgraderBehavior,
      [BehaviorType.GuildClerk]: GuildClerkBehavior,
      [BehaviorType.Guildmaster]: GuildmasterBehavior,
      [BehaviorType.ExitWarper]: ExitWarperBehavior,
      [BehaviorType.SpoilerLogger]: SpoilerLoggerBehavior,
      [BehaviorType.RNGArtificer]: RNGArtificerBehavior,
      [BehaviorType.TreasureClaimer]: TreasureClaimerBehavior,
      [BehaviorType.EventPlanner]: EventPlannerBehavior,
      [BehaviorType.TrinketManager]: TrinketManagerBehavior,
      [BehaviorType.HalloweenCandy]: HalloweenCandyBehavior,
      [BehaviorType.ThanksgivingFood]: ThanksgivingFoodBehavior,
      [BehaviorType.ThanksgivingGuns]: ThanksgivingGunsBehavior,
      [BehaviorType.ThanksgivingTurkey]: ThanksgivingTurkeyBehavior,
      [BehaviorType.ChristmasSanta]: ChristmasSantaBehavior,
    };
