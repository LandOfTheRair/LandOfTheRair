      ...
      <div class="char-middle">
        ...
        <div class="char-gear" *ngIf="!optionService.shrinkCharacterBoxes">
          ...
          <div class="gear-item armor">
            <app-item size="xsmall" [showDesc]="false" [showEncrust]="false" [showCount]="false" [item]="armorItem"></app-item>
          </div>
          <div class="gear-item left">
            <app-item size="xsmall" [showDesc]="false" [showEncrust]="false" [showCount]="false" [item]="leftHand"></app-item>
          </div>
        </div>
