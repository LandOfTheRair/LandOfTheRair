import { DamageArgs, DamageClass, ICharacter, IStatusEffect, ItemSlot, Skill, Stat } from '../../../../../interfaces';
...
export class TigerStance extends Effect {
  ...
  public override create(char: ICharacter, effect: IStatusEffect) {
    ...
    this.game.messageHelper.sendLogMessageToRadius(char, 4, { message: `${char.name} takes on a fierce stance.` });
