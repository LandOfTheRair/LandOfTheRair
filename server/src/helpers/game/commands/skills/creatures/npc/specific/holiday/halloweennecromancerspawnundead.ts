...
export class HalloweenNecromancerSpawnUndead extends SpellCommand {
  ...
  override use(executor: ICharacter, target: ICharacter) {
    ...
    this.game.messageHelper.sendLogMessageToRadius(executor, 8, { message: 'Come forth, my most powerful subjects!' });
    const summonCreatures = ['Halloween Horror', 'Halloween Horror'];
    this.game.effectHelper.addEffect(executor, executor, 'FindFamiliar', { effect: { duration: -1, extra: { summonCreatures } } });
  }
}
