import { directionFromText, directionToOffset, IMacroCommandArgs, IPlayer } from '../../../../../interfaces';
...
export class Door extends MacroCommand {
  ...
  override execute(player: IPlayer, args: IMacroCommandArgs) {
    ...
    const door = this.game.worldManager.getMap(player.map)?.map.getInteractableAt(player.x + offset.x, player.y + offset.y);
    if (!door) {
