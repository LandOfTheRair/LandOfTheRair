...
export class RNGDungeonManager extends BaseService {
  ...
  public generateDungeons(): void {
    ...
    const dungeons = this.game.contentManager.rngDungeonConfigData.dungeonConfigs;
  ...
  private shouldReset(): boolean {
    return this.lastDungeonReset !== this.game.dailyHelper.resetTime.toFormat('yyyy-MM-dd');
  }
