...
import { IRNGDungeonConfig, IRNGDungeonConfigFloor, IRNGDungeonConfigWall, IRNGDungeonMetaConfig, MapLayer } from '../../../interfaces';
import { IGeneratorMapNode } from './MapGenerator';
...
export class RNGDungeonTilemapGenerator {
  ...
  constructor(
    ...
    private readonly mapTheme: { floor: IRNGDungeonConfigFloor; wall: IRNGDungeonConfigWall },
  ...
  autotileWalls(walls: number[], doors: number[], allowEmptyWalls = false): number[] {
