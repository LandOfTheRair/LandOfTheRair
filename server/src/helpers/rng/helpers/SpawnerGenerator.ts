...
import { INPCDefinition, IRNGDungeonConfig, IRNGDungeonMetaConfig, ISpawnerData } from '../../../interfaces';
...
export class RNGDungeonSpawnerGenerator {
  ...
  getSpawners(creatures: INPCDefinition[][]): Array<{ legendary?: INPCDefinition; spawners: ISpawnerData[] }> {
