...
import { IAIBehavior, INPC, IPlayer, distanceFrom, ISpoilerLogger, GameServerResponse, IDialogChatAction } from '../../../../interfaces';
  ...
  init(game: Game, npc: INPC, parser: Parser, behavior: ISpoilerLogger) {
    ...
    parser.addCommand('hello')
      ...
      .setLogic(async ({ env }) => {
        ...
        if (!spoilerLog) return 'Hello, I seem to not have scouted anything today. Check back later!';
